...
swearing_list = {
    ...
    'залупы', 'ахуели', 'пидорас', 'пидор', 'сука', 'гондон', 'ебена', 'пидрила', 'ссаная', 'срань',
    'ссаное', 'уебище', 'залупа'
}
...
hello_users_retail: str = (
    '     <b>Привет</b>, {0} 🖖\n'
    # f'---------------------------------\n'
    f'На связи 🦾 <b>"DNS requests Helper" </b>\n'  # <strong> </strong> 
    # f'---------------------------------\n'
    f'\n'
...
# 0. Общее приветствие для замов ОАИТ и розницы:
hello_users_oait: str = (
    '     <b>Привет</b>, {0} 🖖\n'
    # f'---------------------------------\n'
    f'На связи 🦾 <b>"DNS requests Helper" </b>\n'  # <strong> </strong> 
    # f'---------------------------------\n'
    f'\n'
    f' "Эта ветка находится в разработке, пока что здесь ничего нет. Это тестовый диалог.".\n')
...
category_problem = (f'Доступные категории обращения:\n'
                    f'\n'
                    ...
                    f' *  <b>АР (везет товар):</b> \n'  # prod_coming
                    f' *  <b>АР (не везет товар):</b>\n'  # not_prod_coming
                    f' *  <b>СЕ:</b>\n'
                    f' *  <b>Границам категорий:</b>\n'
                    f' *  <b>Лежакам:</b>\n'
                    ...
                    f' *  <b>МП:</b>\n'
                    f' *  <b>Мерчам:</b>\n'
                    f' *  <b>Ценам на товар:</b>\n'
                    f' *  <b>Закупке товара:</b>\n'
                    f' *  <b>ВЕ:</b>\n'
                    f' *  <b>СТМ:</b>\n'
                    f' *  <b>Уценке:</b>\n'
...
# __________________________________ <code> </code>

# ыбери тему обращения (категорию вопроса / проблемы)
# 1. Тег <code>:
#     - Используется для выделения текста в моноширинный (fixed-width) шрифт.
#     - Полезен для обозначения кода, команд или любого текста, где важно визуальное выравнивание символов.
#
# 2. Тег <pre>:
#     - Используется для отображения текста в предварительно отформатированном виде.
#     - Все пробелы и переносы строк сохраняются.
#     - Хороший способ показать исходный код или другой текст, который требует сохранения форматирования.
...
#                           f'в соответствии с их профилем деятельности, исходя из категории обращения.\n'
#                           f'\n'
#                           f'   *  👍  Направляю уведомления по завершении обработки заявки заказчику,
#                           и много другое...')
